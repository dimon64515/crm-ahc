...
- `/works/:id` — просмотр/редактирование записи о работе
- `/my-works` — список записей текущего пользователя (с возможностью добавить фото)
- `/dashboard` — дашборд директора (таблица работ)
- `/dashboard/summary` — сводный отчёт
- `/photo-backup` — создание и скачивание архива фотографий (director, admin)
- `/settings` — настройки системы (пользователи, корпуса, справочники, бэкапы — admin)
